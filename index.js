import { initRabbitMirrorUI, destroyRabbitMirrorUI } from './src/ui.js?rmv=0.33.84';
import { rabbitMirrorGenerateInterceptor, clearRabbitMirrorPrompt } from './src/injector.js?rmv=0.33.84';
import { clearLastCombo } from './src/storage.js?rmv=0.33.84';
import { initVisualScanner } from './src/visualScanner.js?rmv=0.33.84';
import { initOutputSanitizer, destroyOutputSanitizer } from './src/outputSanitizer.js?rmv=0.33.84';
import { clearAllFeedbackCatState, destroyFeedbackCatPromptSync, initFeedbackCatPromptSync } from './src/feedbackCat.js?rmv=0.33.84';
import { getSettings } from './src/settings.js?rmv=0.33.84';

const RABBIT_MIRROR_RUNTIME_VERSION = '0.33.84';
