import { initRabbitMirrorUI, destroyRabbitMirrorUI } from './src/ui.js?rmv=0.33.81';
import { rabbitMirrorGenerateInterceptor, clearRabbitMirrorPrompt } from './src/injector.js?rmv=0.33.81';
import { clearLastCombo } from './src/storage.js?rmv=0.33.81';
import { initVisualScanner } from './src/visualScanner.js?rmv=0.33.81';
import { initOutputSanitizer, destroyOutputSanitizer } from './src/outputSanitizer.js?rmv=0.33.81';
import { clearAllFeedbackCatState, destroyFeedbackCatPromptSync, initFeedbackCatPromptSync } from './src/feedbackCat.js?rmv=0.33.81';
import { getSettings } from './src/settings.js?rmv=0.33.81';

const RABBIT_MIRROR_RUNTIME_VERSION = '0.33.81';
