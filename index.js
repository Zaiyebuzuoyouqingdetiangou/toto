...
async function ensureDeferredCoreRuntime(reason = 'scheduled-idle') {
    ...
    deferredRuntimePromise = Promise.all([
        import('./src/outputSanitizer.js?rmv=1.5.26-compat1'),
        import('./src/visualScanner.js?rmv=1.5.26-compat1'),
        import('./src/independentApi.js?rmv=1.5.26-compat1'),
        import('./src/touchTheater.js?rmv=1.5.26-compat1'),
        import('./src/ui.js?rmv=1.5.26-compat1'),
...
function loadMirrorVisualCompat() {
    ...
    return Promise.all([
        ...
        loadOptional('renderedVisualFeedback', './src/renderedVisualFeedbackHotfix.js?rmv=1.5.26-compat1', mod => mod.initRabbitMirrorRenderedVisualFeedbackHotfix?.()),
    ]);
}
