const LIGHT_BOOT_VERSION = '1.4.11';
...
const SPECS = Object.freeze({
    performanceDiagnostics: './src/performanceDiagnostics.js?rmv=1.4.11-chatsafety1',
    settings: './src/settings.js?rmv=1.4.11-chatsafety1',
    storage: './src/storage.js?rmv=1.4.11-chatsafety1',
    generationGuard: './src/generationGuard.js?rmv=1.4.11-chatsafety1',
    feedbackCat: './src/feedbackCat.js?rmv=1.4.11-chatsafety1',
    independentSecurityGuard: './src/independentSecurityGuard.js?rmv=1.4.11-chatsafety1',
    injector: './src/injector.js?rmv=1.4.11-chatsafety1',
    outputSanitizer: './src/outputSanitizer.js?rmv=1.4.11-chatsafety1',
    checkedSelectorRepair: './src/checkedSelectorRepair.js?rmv=1.4.30.26',
    visualScanner: './src/visualScanner.js?rmv=1.4.11-chatsafety1',
    renderedVisualFeedbackHotfix: './src/renderedVisualFeedbackHotfix.js?rmv=1.4.11-chatsafety1',
    independentApi: './src/independentApi.js?rmv=1.4.11-chatsafety1',
    touchTheater: './src/touchTheater.js?rmv=1.4.11-chatsafety1',
    ...
    ui: './src/ui.js?rmv=1.4.11-chatsafety1',
});
