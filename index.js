import { rabbitMirrorGenerateInterceptor, clearRabbitMirrorPrompt, destroyIndependentGenerationIntentBridge, initIndependentGenerationIntentBridge, prewarmRabbitMirrorGenerationRuntime } from './src/injector.js?rmv=1.5.53-manualdiag1';
...
async function ensureDeferredCoreRuntime(reason = 'scheduled-idle') {
    ...
    deferredRuntimePromise = Promise.all([
        import('./src/outputSanitizer.js?rmv=1.5.53-manualdiag1'),
        ...
        import('./src/ui.js?rmv=1.5.53-mobileui1'),
...
function loadMirrorVisualCompat() {
    ...
    return Promise.all([
        ...
        loadOptional('renderedVisualFeedback', './src/renderedVisualFeedbackHotfix.js?rmv=1.5.53-manualdiag1', mod => mod.initRabbitMirrorRenderedVisualFeedbackHotfix?.()),
    ]);
}
