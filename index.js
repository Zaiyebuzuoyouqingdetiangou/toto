import { rabbitMirrorGenerateInterceptor, clearRabbitMirrorPrompt, destroyIndependentGenerationIntentBridge, initIndependentGenerationIntentBridge, prewarmRabbitMirrorGenerationRuntime } from './src/injector.js?rmv=1.6.4-longtext1';
...
import { getSettings, updateSettings } from './src/settings.js?rmv=1.6.4-longtext1';
import { installRabbitMirrorPublicAPI } from './src/publicApi.js?rmv=1.6.4-longtext1';
...
async function ensureDeferredCoreRuntime(reason = 'scheduled-idle') {
    ...
    deferredRuntimePromise = Promise.all([
        import('./src/outputSanitizer.js?rmv=1.6.4-longtext1'),
        import('./src/visualScanner.js?rmv=1.6.4-longtext1'),
        import('./src/independentApi.js?rmv=1.6.4-longtext1'),
        import('./src/touchTheater.js?rmv=1.6.3-ttchild1'),
        import('./src/ui.js?rmv=1.6.4-longtext1'),
...
function clearDeferredGenerationSnapshots() {
    void import('./src/generationGuard.js?rmv=1.6.4-longtext1')
        .then(mod => {
