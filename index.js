import { rabbitMirrorGenerateInterceptor, clearRabbitMirrorPrompt, destroyIndependentGenerationIntentBridge, initIndependentGenerationIntentBridge, prewarmRabbitMirrorGenerationRuntime } from './src/injector.js?rmv=1.6.16-test.10';
import { clearLastCombo } from './src/storage.js?rmv=1.6.16-test.10';
...
import { getSettings, updateSettings } from './src/settings.js?rmv=1.6.16-test.10';
import { installRabbitMirrorPublicAPI } from './src/publicApi.js?rmv=1.6.16-test.10';
import { initRabbitMirrorIndependentSecurityGuard, destroyRabbitMirrorIndependentSecurityGuard } from './src/independentSecurityGuard.js?rmv=1.6.16-test.10';
...
async function ensureDeferredCoreRuntime(reason = 'scheduled-idle') {
    ...
    deferredRuntimePromise = Promise.all([
        import('./src/outputSanitizer.js?rmv=1.6.16-test.10'),
        import('./src/visualScanner.js?rmv=1.6.16-test.10'),
        import('./src/independentApi.js?rmv=1.6.16-test.10'),
        import('./src/touchTheater.js?rmv=1.6.3-ttchild1'),
        import('./src/ui.js?rmv=1.6.16-test.10'),
...
function loadMirrorVisualCompat() {
    ...
    return Promise.all([
        ...
        loadOptional('renderedVisualFeedback', './src/renderedVisualFeedbackHotfix.js?rmv=1.6.16-test.10', mod => mod.initRabbitMirrorRenderedVisualFeedbackHotfix?.()),
    ]);
}
...
function clearDeferredGenerationSnapshots() {
    void import('./src/generationGuard.js?rmv=1.6.16-test.10')
        .then(mod => {
