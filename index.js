import { rabbitMirrorGenerateInterceptor, clearRabbitMirrorPrompt, destroyIndependentGenerationIntentBridge, initIndependentGenerationIntentBridge, prewarmRabbitMirrorGenerationRuntime } from './src/injector.js?rmv=1.5.53-visualquick1';
...
import { getSettings, updateSettings } from './src/settings.js?rmv=1.5.53-visualquick1';
...
async function ensureDeferredCoreRuntime(reason = 'scheduled-idle') {
    ...
    deferredRuntimePromise = Promise.all([
        import('./src/outputSanitizer.js?rmv=1.5.53-visualquick1'),
        import('./src/visualScanner.js?rmv=1.5.53-visualquick1'),
        import('./src/independentApi.js?rmv=1.5.53-visualquick1'),
        import('./src/touchTheater.js?rmv=1.5.53-cn-boundary1'),
        import('./src/ui.js?rmv=1.5.53-visualquick1'),
...
function loadMirrorVisualCompat() {
    ...
    return Promise.all([
        ...
        loadOptional('renderedVisualFeedback', './src/renderedVisualFeedbackHotfix.js?rmv=1.5.53-visualquick1', mod => mod.initRabbitMirrorRenderedVisualFeedbackHotfix?.()),
    ]);
}
...
function clearDeferredGenerationSnapshots() {
    void import('./src/generationGuard.js?rmv=1.5.53-visualquick1')
        .then(mod => {
