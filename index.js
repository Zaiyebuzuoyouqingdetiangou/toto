import { initRabbitMirrorUI, destroyRabbitMirrorUI } from './src/ui.js?rmv=1.1.0b15';
import { rabbitMirrorGenerateInterceptor, clearRabbitMirrorPrompt } from './src/injector.js?rmv=1.1.0b15';
import { clearLastCombo } from './src/storage.js?rmv=1.1.0b15';
import { initVisualScanner } from './src/visualScanner.js?rmv=1.1.0b15';
import { initOutputSanitizer, destroyOutputSanitizer } from './src/outputSanitizer.js?rmv=1.1.0b15';
import { clearAllFeedbackCatState, destroyFeedbackCatPromptSync, initFeedbackCatPromptSync } from './src/feedbackCat.js?rmv=1.1.0b15';
import { getSettings } from './src/settings.js?rmv=1.1.0b15';
import { clearRabbitMirrorGenerationSnapshots } from './src/generationGuard.js?rmv=1.1.0b15';

const RABBIT_MIRROR_RUNTIME_VERSION = '1.1.0-beta.15';
