import { THEMATIC_CATEGORIES } from '../data/structured/thematicIndex.js?rmv=1.1.0b15';
import { PRESENTATION_FORMATS } from '../data/structured/presentationIndex.js?rmv=1.1.0b15';
import {
    getCurrentChatKey,
