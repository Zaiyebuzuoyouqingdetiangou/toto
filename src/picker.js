import { THEMATIC_CATEGORIES } from '../data/structured/thematicIndex.js?rmv=1.1.0b10';
import { PRESENTATION_FORMATS } from '../data/structured/presentationIndex.js?rmv=1.1.0b10';
import {
    getCurrentChatKey,
