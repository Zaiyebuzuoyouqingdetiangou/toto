...
import { getCurrentChatKey, updateLatestVisualSignature } from './storage.js?rmv=1.6.16-test.5';
...
} from './generationGuard.js?rmv=1.6.16-test.5';
import {
...
} from './multifaceProof.js?rmv=1.6.16-test.5';
...
import { saveFollowPartialResult } from './followPartialResults.js?rmv=1.6.16-test.5';
...
function loadFollowBatchSanitizer() {
    if (!followBatchSanitizerModulePromise) {
        followBatchSanitizerModulePromise = import('./outputSanitizer.js?rmv=1.6.16-test.5').catch(error => {
