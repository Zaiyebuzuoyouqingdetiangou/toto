...
import { getCurrentChatKey, updateLatestVisualSignature } from './storage.js?rmv=1.6.16-test.3';
...
} from './generationGuard.js?rmv=1.6.16-test.3';
import {
...
} from './multifaceProof.js?rmv=1.6.16-test.3';
...
import { saveFollowPartialResult } from './followPartialResults.js?rmv=1.6.16-test.3';
...
function loadFollowBatchSanitizer() {
    if (!followBatchSanitizerModulePromise) {
        followBatchSanitizerModulePromise = import('./outputSanitizer.js?rmv=1.6.16-test.3').catch(error => {
