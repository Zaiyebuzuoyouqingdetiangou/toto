...
import { getCurrentChatKey, updateLatestVisualSignature } from './storage.js?rmv=1.6.16-test.2';
...
} from './generationGuard.js?rmv=1.6.16-test.2';
import {
...
} from './multifaceProof.js?rmv=1.6.16-test.2';
...
import { saveFollowPartialResult } from './followPartialResults.js?rmv=1.6.16-test.2';
...
function loadFollowBatchSanitizer() {
    if (!followBatchSanitizerModulePromise) {
        followBatchSanitizerModulePromise = import('./outputSanitizer.js?rmv=1.6.16-test.2').catch(error => {
