...
import { refreshRabbitMirrorToolsInScope } from '../outputSanitizer.js?rmv=1.6.16-test.11';
...
import { independentRecordWithinBudget, readStore, writePersistedOwner, writeStore } from './persistence.js?rmv=1.6.16-test.11';
import { chatKey, saveRecordForSlot, savedIndependentRecordForOwner, swipeId } from './connection.js?rmv=1.6.16-test.11';
import { hasMultifaceMarkup, wrapIndependentFace } from './request.js?rmv=1.6.16-test.11';
import { externalFaceDetails, showIndependentUnsavedOutput } from './mount.js?rmv=1.6.16-test.11';
