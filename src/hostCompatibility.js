...
import { createRabbitMirrorHostCompatibility as createHostCompatibility } from './hostCompatibilityCore.js?rmv=1.5.48-externalfix1';

const COHORT = '1.5.48-externalfix1';
