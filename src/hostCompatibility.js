...
import { createRabbitMirrorHostCompatibility as createHostCompatibility } from './hostCompatibilityCore.js?rmv=1.5.53-cn-boundary1';

const COHORT = '1.5.53-cn-boundary1';
