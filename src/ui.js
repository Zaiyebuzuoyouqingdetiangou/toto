...
<div id="rabbit_mirror_theater_settings" class="rabbit-mirror-settings">
  <div class="inline-drawer">
    <div class="inline-drawer-toggle inline-drawer-header">
      <b>兔子镜小剧场 / Rabbit Mirror Theater <span style="font-size:11px;opacity:.72;">[小小维修兔 v1.8＋Menu QR v2.1 测试版]</span></b><span class="rabbit-mirror-toto-watermark">Toto v0.33.10 TEST</span>
      ...
      <details class="rabbit-mirror-section rabbit-mirror-emergency rabbit-mirror-emergency-prominent">
        ...
        <div class="rabbit-mirror-section-content">
          ...
          <div class="rabbit-mirror-maintenance-help" style="margin-top:8px;padding:10px 0;border-top:1px dashed color-mix(in srgb, var(--SmartThemeBorderColor) 62%, transparent);border-bottom:1px dashed color-mix(in srgb, var(--SmartThemeBorderColor) 62%, transparent);">
            <div style="font-weight:700;margin-bottom:5px;">🐇 小小维修兔 v1.8</div>
            <div class="rabbit-mirror-subnote" style="opacity:.8;font-size:12px;line-height:1.55;">点击标题后的维修兔，会打开本地菜单：点了没反应／显示了一堆代码／样子不对／全部试试（强制维修）／全链路诊断。绿灯也可以手动维修。</div>
            <div class="rabbit-mirror-subnote" style="margin-top:5px;opacity:.72;font-size:12px;line-height:1.5;">维修兔的自动巡逻仍遵循“没有证据就不修改”；只有用户明确选择某种问题或“全部试试”时，才会对当前这一面兔子镜执行对应维修路线。所有菜单操作均为本地 UI，不增加模型 token。</div>
          </div>
