import { getSettings, updateSettings, resetSettings } from './settings.js?rmv=0.33.73';
import { clearLastCombo } from './storage.js?rmv=0.33.73';
import { clearRabbitMirrorPrompt } from './injector.js?rmv=0.33.73';
import { clearFeedbackCatExtensionPrompt, getActiveFeedbackForCurrentChat, syncFeedbackCatExtensionPrompt } from './feedbackCat.js?rmv=0.33.73';
import { refreshFeedbackCats, refreshMaintenanceRabbits, triggerInteractionDiagnosticOnce } from './outputSanitizer.js?rmv=0.33.73';
import { scanMemoryPlugins, testMemoryProvider } from './memoryScanner.js?rmv=0.33.73';

const SETTINGS_UI_VERSION = '0.33.73';
...
<div id="rabbit_mirror_theater_settings" class="rabbit-mirror-settings" data-rabbit-mirror-ui-version="${SETTINGS_UI_VERSION}" data-rabbit-mirror-runtime-version="${RUNTIME_VERSION}">
  <div class="inline-drawer">
    <div class="inline-drawer-toggle inline-drawer-header">
      <b>兔子镜小剧场 / Rabbit Mirror Theater <span style="font-size:11px;opacity:.72;">[挨打猫 v1.4＋小小维修兔 v1.51＋Menu QR v2.1]</span></b><span class="rabbit-mirror-toto-watermark">Toto v0.33.73 TEST</span>
