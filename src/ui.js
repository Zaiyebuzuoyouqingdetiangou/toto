...
<div id="rabbit_mirror_theater_settings" class="rabbit-mirror-settings">
  <div class="inline-drawer">
    <div class="inline-drawer-toggle inline-drawer-header">
      <b>兔子镜小剧场 / Rabbit Mirror Theater</b><span class="rabbit-mirror-toto-watermark">Toto v0.32.13</span>
    ...
    <div class="inline-drawer-content">
      ...
      <div class="rabbit-mirror-subnote" style="margin:-2px 0 6px 26px;opacity:.72;font-size:12px;line-height:1.45;">开启后强制本轮使用 Visual Scenery 视觉画布，以 CSS 构成画面、物件、空间或象征性视觉片段；文字仅作辅助，动画按画面需要自然使用。</div>
      ...
      <label class="checkbox_label"><input id="rh_avoid_repeat" type="checkbox"> 10轮冷却：避免重复主题/展现形式/配色观感</label>
      <div class="rabbit-mirror-subnote" style="margin:-2px 0 6px 26px;opacity:.72;font-size:12px;line-height:1.45;">仅记录已经实际生成成功的兔子镜；连续两轮出现深色低饱和主画面时，本地启动5轮视觉身份冷却，违规暗色会重置冷却。</div>
