...
<div id="rabbit_mirror_theater_settings" class="rabbit-mirror-settings">
  <div class="inline-drawer">
    <div class="inline-drawer-toggle inline-drawer-header">
      <b>兔子镜小剧场 / Rabbit Mirror Theater</b><span class="rabbit-mirror-toto-watermark">Toto v0.31.45</span>
    ...
    <div class="inline-drawer-content">
      ...
      <div class="rabbit-mirror-subnote" style="margin:-2px 0 6px 26px;opacity:.72;font-size:12px;line-height:1.45;">开启后允许生成纯 CSS 风景与流动渐变效果。</div>

      <label class="checkbox_label"><input id="rh_force_interactive" type="checkbox"> 每轮可交互模式</label>
