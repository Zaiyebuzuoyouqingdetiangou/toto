...
5. 文字只能作为标题、短注、坐标、题签、极短旁白或画面标注；不得让多段说明、选项块或长文本成为主体。
6. 若最终结果看起来主要是在阅读文字，而不是观看一幅由 CSS 构成的画面，则视为未执行 Visual Scenery，必须改写为视觉画布优先。
`;
...
15. 【最终结尾检查】本轮回复的最后一个可见模块必须是完整的兔子洞 <details> 小剧场。
</RabbitHoleTheaterAutoInjection>
`;
