...
import { MODULE_NAME, getSettings } from './settings.js?rmv=1.3.1';
...
import { recordRabbitMirrorInjection, recordRabbitMirrorNoInjection } from './tokenMeter.js?rmv=1.3.1';
import { beginRabbitMirrorGenerationAttempt } from './generationGuard.js?rmv=1.3.1';
