...
import { getCurrentChatKey } from './storage.js?rmv=1.5.49-ttimmediate1';
import { getRabbitMirrorRecipe } from './blacklist.js?rmv=1.5.49-ttimmediate1';
import { readFollowPartialResult, replaceFollowPartialResultFace } from './followPartialResults.js?rmv=1.5.49-ttimmediate1';
...
import { parseMultifaceOutput, MULTIFACE_FAILURE_ATTR } from './multifaceProtocol.js?rmv=1.5.49-ttimmediate1';
import { planRabbitMirrorPromptDetails, renderRabbitMirrorPromptPlan, prepareSelectedMemoryForPrompt, memoryRequestSettingsKey, assertMemoryRequestSettings } from './promptBuilder.js?rmv=1.5.49-ttimmediate1';
import { hydrateExternalPoolMetadata, getSelectedExternalEntries } from './externalWorldBook/store.js?rmv=1.5.49-ttimmediate1';
import { refreshRabbitMirrorToolsInScope, isolateRabbitMirrorInteractionIds } from './outputSanitizer.js?rmv=1.5.49-ttimmediate1';
import { authorizeRabbitMirrorIndependentServiceRequest, assertRabbitMirrorIndependentResponseText } from './independentSecurityGuard.js?rmv=1.5.49-ttimmediate1';
    ...
    try {
        ...
        try {
            ...
            if(plan.appearanceReference.enabled){
                const appearance=await import('./appearanceReference.js?rmv=1.5.49-ttimmediate1');assertCurrent();
