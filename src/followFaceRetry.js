...
import { getCurrentChatKey } from './storage.js?rmv=1.5.26-compat1';
import { getRabbitMirrorRecipe } from './blacklist.js?rmv=1.5.26-compat1';
import { readFollowPartialResult, replaceFollowPartialResultFace } from './followPartialResults.js?rmv=1.5.26-compat1';
...
import { parseMultifaceOutput, MULTIFACE_FAILURE_ATTR } from './multifaceProtocol.js?rmv=1.5.26-compat1';
import { planRabbitMirrorPromptDetails, renderRabbitMirrorPromptPlan } from './promptBuilder.js?rmv=1.5.26-content-title1';
...
import { refreshRabbitMirrorToolsInScope, isolateRabbitMirrorInteractionIds } from './outputSanitizer.js?rmv=1.5.26-content-title1';
