...
import { getRabbitMirrorGenerationSnapshot } from '../generationGuard.js?rmv=1.6.4-longtext3';
...
import { getClassTokens, isCollapsedDimensionValue, normalizeStylePropertyName } from './renderedStateRescue.js?rmv=1.6.4-longtext3';
import {
...
} from './fallbackRescue.js?rmv=1.6.4-longtext3';
import {
...
} from './idsAndRearm.js?rmv=1.6.4-longtext3';
import {
...
} from './choiceRescue.js?rmv=1.6.4-longtext3';
import {
    FENCED_BLOCK_RE,
...
} from './toolsChrome.js?rmv=1.6.4-longtext3';
import {
...
export async function runMaintenanceNarrowFaceRepair(root, button) {
    ...
    try {
        ...
        const adapter = await import('../independentApi.js?rmv=1.6.4-longtext3');
