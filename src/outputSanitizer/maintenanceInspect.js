...
import { getRabbitMirrorGenerationSnapshot } from '../generationGuard.js?rmv=1.6.10';
...
} from './checkedStateRescue.js?rmv=1.6.10';
import { getClassTokens, isCollapsedDimensionValue, normalizeStylePropertyName } from './renderedStateRescue.js?rmv=1.6.10';
import {
...
} from './scriptedInteractionRescue.js?rmv=1.6.10';
import {
...
} from './fallbackRescue.js?rmv=1.6.10';
import {
...
} from './idsAndRearm.js?rmv=1.6.10';
import {
...
} from './choiceRescue.js?rmv=1.6.10';
import {
    FENCED_BLOCK_RE,
...
} from './toolsChrome.js?rmv=1.6.10';
import {
...
export async function runMaintenanceNarrowFaceRepair(root, button) {
    ...
    try {
        ...
        const adapter = await import('../independentApi.js?rmv=1.6.10');
