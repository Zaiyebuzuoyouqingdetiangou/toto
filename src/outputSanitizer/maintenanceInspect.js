...
import { getRabbitMirrorGenerationSnapshot } from '../generationGuard.js?rmv=1.6.12';
...
import { getClassTokens, isCollapsedDimensionValue, normalizeStylePropertyName } from './renderedStateRescue.js?rmv=1.6.12';
import {
...
} from './idsAndRearm.js?rmv=1.6.12';
import {
...
} from './choiceRescue.js?rmv=1.6.12';
import {
    FENCED_BLOCK_RE,
...
} from './toolsChrome.js?rmv=1.6.12';
import {
...
export async function runMaintenanceNarrowFaceRepair(root, button) {
    ...
    try {
        ...
        const adapter = await import('../independentApi.js?rmv=1.6.12');
