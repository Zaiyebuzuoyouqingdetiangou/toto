...
import { getRabbitMirrorGenerationSnapshot } from '../generationGuard.js?rmv=1.6.16-test.5';
...
import { getClassTokens, isCollapsedDimensionValue, normalizeStylePropertyName } from './renderedStateRescue.js?rmv=1.6.16-test.5';
import {
...
} from './idsAndRearm.js?rmv=1.6.16-test.5';
import {
...
} from './choiceRescue.js?rmv=1.6.16-test.5';
import {
    FENCED_BLOCK_RE,
...
} from './markup.js?rmv=1.6.16-test.5';
import {
...
} from './toolsChrome.js?rmv=1.6.16-test.5';
import {
...
export async function runMaintenanceNarrowFaceRepair(root, button) {
    ...
    try {
        ...
        const adapter = await import('../independentApi.js?rmv=1.6.16-test.5');
