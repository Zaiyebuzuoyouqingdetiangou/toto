...
import { getClassTokens, isCollapsedDimensionValue, normalizeStylePropertyName } from './renderedStateRescue.js?rmv=1.6.4-resay1';
import {
...
} from './idsAndRearm.js?rmv=1.6.4-resay1';
import {
...
} from './choiceRescue.js?rmv=1.6.4-resay1';
import {
    FENCED_BLOCK_RE,
...
export async function runMaintenanceNarrowFaceRepair(root, button) {
    ...
    try {
        ...
        const adapter = await import('../independentApi.js?rmv=1.6.4-resay1');
