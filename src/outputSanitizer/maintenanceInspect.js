...
import { getRabbitMirrorGenerationSnapshot } from '../generationGuard.js?rmv=1.6.9';
...
} from './checkedStateRescue.js?rmv=1.6.9';
import { getClassTokens, isCollapsedDimensionValue, normalizeStylePropertyName } from './renderedStateRescue.js?rmv=1.6.9';
import {
...
} from './scriptedInteractionRescue.js?rmv=1.6.9';
import {
...
} from './fallbackRescue.js?rmv=1.6.9';
import {
...
} from './choiceRescue.js?rmv=1.6.9';
import {
    FENCED_BLOCK_RE,
...
export async function runMaintenanceNarrowFaceRepair(root, button) {
    ...
    try {
        ...
        const adapter = await import('../independentApi.js?rmv=1.6.9');
