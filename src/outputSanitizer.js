...
} from './feedbackCat.js?rmv=0.33.47';
import { scanRabbitMirrorHtml } from './visualScanner.js?rmv=0.33.47';
...
const INTERACTION_DIAGNOSTIC_VERSION = '0.33.47-TEST-FULL-CHAIN';
