import { getSettings } from './settings.js?rmv=1.1.0b2';
import {
    FEEDBACK_CAT_TYPES,
...
import { scanRabbitMirrorHtml } from './visualScanner.js?rmv=1.1.0b2';
...
const INTERACTION_DIAGNOSTIC_VERSION = '1.1.0-BETA-2-FULL-CHAIN';
