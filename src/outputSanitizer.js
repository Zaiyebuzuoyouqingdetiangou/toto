...
} from './feedbackCat.js?rmv=0.33.45';
import { scanRabbitMirrorHtml } from './visualScanner.js?rmv=0.33.45';
...
const INTERACTION_DIAGNOSTIC_VERSION = '0.33.45-TEST-FULL-CHAIN';
