...
更新：2026-09-07。当前发布包：1.5.26，基于保留的 1.5.25；manifest/runtime 为 `1.5.26`，主 cache cohort 为 `1.5.26-compat1`。本文是本包唯一 CURRENT；以下旧版本条目属于历史约束。跨设备保存尚未实现，手机热与长延迟仍需实机验收。
